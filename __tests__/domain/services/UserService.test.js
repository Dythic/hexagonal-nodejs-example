...
describe('UserService', () => {
  ...
  describe('createUser', () => {
    ...
    it('devrait rejeter si l\'utilisateur existe déjà', async () => {
      ...
      await expect(userService.createUser('test@example.com', 'John Doe'))
    ...
    it('devrait créer l\'utilisateur même si l\'email échoue', async () => {
      ...
      expect(result).toBe(savedUser);
      expect(consoleWarnSpy).toHaveBeenCalledWith('Échec envoi email de bienvenue:', 'Email service error');
