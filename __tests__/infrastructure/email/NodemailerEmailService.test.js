...
describe('EmailService Integration', () => {
  ...
  describe('Compatibilité avec le contrat EmailService', () => {
    ...
    it('devrait accepter des objets utilisateur conformes', async () => {
      ...
      await expect(emailService.sendWelcomeEmail(validUser)).resolves.toBeDefined();
    });
    ...
    it('devrait gérer les utilisateurs avec des propriétés supplémentaires', async () => {
      ...
      await expect(emailService.sendWelcomeEmail(userWithExtraProps)).resolves.toBeDefined();
    });
  });
});
  ...
  describe('sendWelcomeEmail', () => {
    ...
    it('devrait propager les erreurs du transporter', async () => {
      ...
      await expect(emailService.sendWelcomeEmail(testUser))
        .rejects.toThrow('SMTP Error: Connection failed');
    });
