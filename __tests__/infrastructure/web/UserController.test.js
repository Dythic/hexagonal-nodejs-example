...
describe("UserController", () => {
  ...
  describe("POST /api/users", () => {
    ...
    it("devrait gérer les erreurs de service", async () => {
      mockUserService.createUser.mockRejectedValue(
        new Error("Utilisateur existe déjà"),
      );
  ...
  describe("GET /api/users/:id", () => {
    ...
    it("devrait retourner 404 pour un utilisateur inexistant", async () => {
      ...
      const response = await request(app).get("/api/users/123").expect(404);
  ...
  describe("DELETE /api/users/:id", () => {
    it("devrait supprimer un utilisateur existant", async () => {
      ...
      const response = await request(app).delete("/api/users/123").expect(200);
    ...
    it("devrait retourner 404 pour un utilisateur inexistant", async () => {
      ...
      const response = await request(app).delete("/api/users/123").expect(404);
