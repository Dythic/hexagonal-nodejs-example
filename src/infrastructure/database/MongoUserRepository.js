...
class MongoUserRepository extends UserRepository {
  ...
  async save(user) {
    if (user.id) {
      ...
      return new User(result.insertedId.toString(), user.email, user.name, user.createdAt);
    }
  }
  ...
  async findAll() {
    ...
    return docs.map(doc => new User(doc._id.toString(), doc.email, doc.name, doc.createdAt));
  }
